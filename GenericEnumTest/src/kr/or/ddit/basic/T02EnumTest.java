...
public class T02EnumTest {
	...
	//데이터 값을 임의로지정한 열거형 객체 선언
	//데이터 값을 정해 줄 경우에는 생성자 를 만들어서 괄호속의 값을 읽어올수있다.
	public enum Season{
		봄("3월부터 5월까지"), 여름("6월부터 8월까지"),
		가을("9월부터 11월까지"), 겨울("13월부터 2월까지");
	...
	public static void main(String[] args) {
		...
		*/
		...
		myCity1= City.서울; //객체가 만들어져서 myCity1에 담김
		...
		System.out.println("대전=>"+city.compareTo(City.대전));//계산 ??
